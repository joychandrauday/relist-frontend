                    ...
                    <div className="flex space-x-6">
                        {categories?.map((category) => (
                            <Link href={`/products?category=${category.name}`} key={category._id}>
                                <div className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:-translate-y-1 transition duration-300 cursor-pointer p-4 flex flex-col items-center w-60">
                                    {/* 📌 Category Info */}
